...
const ChatBot = () => {
    ...
    const [messages, setMessages] = useState([
        {
            text: "مرحبًا بك في Mind Gate AI! أنا هنا لتخطيط رحلتك المثالية. أخبرني عن خطط سفرك أو جرب اقتراحًا أدناه!",
            sender: "bot",
            language: "ar",
        },
        {
            text: "Welcome to Mind Gate AI! I'm here to plan your dream Mind. Tell me about your travel plans or try a suggestion below!",
            sender: "bot",
            language: "en",
        },
    ]);
    ...
    const suggestions = [
        {
            ...
            icon: <Map size={16} />,
            prompt: {
                en: "Suggest popular travel destinations for a week-long Mind.",
        ...
        },
        {
            ...
            prompt: {
                en: "How can I plan a Mind on a budget? Suggest affordable destinations.",
