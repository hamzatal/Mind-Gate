...
const PackagesPage = ({ auth, packages = [] }) => {
    ...
    return (
        <div className="min-h-screen bg-gray-950 text-white">
            <Head>
                <title>Packages - Mind Gate</title>
                <meta
                    name="description"
                    content="Explore our curated selection of travel packages with Mind Gate."
                />
            </Head>
            ...
            <section className="relative pt-28 pb-16 md:pt-36 md:pb-5 bg-gradient-to-b from-emerald-950/70 via-gray-950 to-gray-950">
                <div className="max-w-6xl mx-auto px-6 text-center">
                    ...
                    >
                        Discover handpicked travel packages to the word's most
