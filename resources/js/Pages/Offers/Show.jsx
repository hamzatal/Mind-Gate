...
export default function Show({ offer = {}, auth }) {
    ...
    return (
        <div className="min-h-screen bg-gray-950 text-white">
            <Head title={`${offer.title || "Special Offer"} - Mind Gate`} />
                        ...
                        >
                            ...
                            <div className="prose prose-lg prose-invert max-w-none">
                                <p className="text-gray-300 leading-relaxed whitespace-pre-line">
                                    {offer.description ||
                                        "Take advantage of this excGateive special offer! Limited availability - book now to secure your spot at an incredible price."}
                                </p>
                            </div>
                        </motion.div>
