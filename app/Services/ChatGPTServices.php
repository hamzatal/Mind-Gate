...
class ChatGPTServices
{
    ...
    {
        $basePrompt = "You are Mind Gate AI, a professional travel planning expert with extensive knowledge of global destinations, travel logistics, and cultural insights.";
