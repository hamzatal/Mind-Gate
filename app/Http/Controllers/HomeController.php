...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $translations = [
            ...
            'destinations_subtitle' => __('Discover our most popular vacation spots loved by travelers wordwide'),
            ...
            'benefits' => [
                ...
                [
                    ...
                    'description' => __('Earn points with every booking and enjoy excGateive benefits.')
                ]
            ],
            ...
            'over_200_destinations' => __('Over 200+ exotic locations to discover around the word')
        ];
